...
metadata {
	...
	tiles (scale: 2){   
        ...
        valueTile("carbonDioxide", "device.carbonDioxide", inactiveLabel: false, width: 2, height: 2, decoration: "flat") {
        	state "carbonDioxide", label:'${currentValue} CO2 ppm', unit:"ppm",backgroundColors:[
...
private getAPIKey() {
    return "eyJhbGciOiJIUzI1NiJ9.eyJncmFudGVlIjoibWFpbEBqYW53ZXJuZXIuZGUiLCJpYXQiOjE1MDY3OTEzNDYsInZhbGlkaXR5IjotMSwianRpIjoiN2E2NzEzMGUtNDRhZC00NjQyLTlmZjEtMmMyNWQzMzBhMDBlIiwicGVybWlzc2lvbnMiOlsidXNlcjpyZWFkIiwiZGV2aWNlOnJlYWQiXSwicXVvdGEiOjIwMCwicmF0ZUxpbWl0Ijo1fQ.i0yn_zdkUplzxTt1FdpBXG37SOZwbVvspgNO6gPo83c"
}
